...
from etlfactory.factory.validation.abs_validation import AbsValidation
...
class ETL_Factory(AbsFactory):
    ...
    def validation_method(self):
        ...
        self.params = self.config['Data_Validation']

        module = loader(self.params['method'], self.params['path'], AbsValidation)
        module.execute(
    ...
    def load_method(self):
        ...
        for method in self.config["Load"].keys():
            ...
            module = loader(method, path, AbsLoad)
